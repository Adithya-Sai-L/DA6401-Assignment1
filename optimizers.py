...
class SGD(BaseOptimizer):
    def __init__(self, weights=None, biases=None, lr=1e-3, weight_decay=0, name="SGD"):
    ...
    def update(self, dW, dB):
        for layer in range(len(self.weights)):
            # Add weight decay term to both weights and biases
            dW[layer] += self.weight_decay * self.weights[layer]
            dB[layer] += self.weight_decay * self.biases[layer]
            
            self.weights[layer] -= self.lr * dW[layer]
            self.biases[layer] -= self.lr * dB[layer]

class Momentum(BaseOptimizer):
    def __init__(self, weights=None, biases=None, lr=1e-3, momentum=0.9, weight_decay=0, name="Momentum"):
        super().__init__(name, lr)
        self.weights = weights
        self.biases = biases
...
class NestrovMomentum(BaseOptimizer):
    def __init__(self, weights=None, biases=None, lr=1e-3, momentum=0.9, weight_decay=0, name="NestrovMomentum"):
        super().__init__(name, lr)
        self.weights = weights
        self.biases = biases
        self.momentum = momentum
...
class RMSProp(BaseOptimizer):
    def __init__(self, weights=None, biases=None, lr=1e-3, beta=0.9, epsilon=1e-6, weight_decay=0, name="RMSProp"):
        super().__init__(name, lr)
        self.weights = weights
        self.biases = biases
        self.beta = beta
...
class Adam(BaseOptimizer):
    def __init__(self, weights=None, biases=None, lr=1e-3, beta1=0.9, beta2=0.999, epsilon=1e-6, weight_decay=0, name="Adam"):
        super().__init__(name, lr)
        self.weights = weights
        self.biases = biases
        self.beta1 = beta1
...
class Nadam(BaseOptimizer):
    def __init__(self, weights=None, biases=None, lr=1e-3, beta1=0.9, beta2=0.999, epsilon=1e-6, weight_decay=0, name="Nadam"):
        super().__init__(name, lr)
        self.weights = weights
        self.biases = biases
        self.beta1 = beta1
...
def create_optimizer(args, weights, biases):
    if args.optimizer == "sgd":
        return SGD(weights,biases,lr=args.learning_rate, weight_decay=args.weight_decay)
    elif args.optimizer == "momentum":
        return Momentum(weights,biases,lr=args.learning_rate,momentum=args.momentum, weight_decay=args.weight_decay)
    elif args.optimizer == "nag":
        return NestrovMomentum(weights,biases,lr=args.learning_rate,momentum=args.momentum, weight_decay=args.weight_decay)
    elif args.optimizer == "rmsprop":
        return RMSProp(weights,biases,lr=args.learning_rate,beta=args.beta,epsilon=args.epsilon, weight_decay=args.weight_decay)
    elif args.optimizer == "adam":
        return Adam(weights,biases,lr=args.learning_rate,beta1=args.beta1,beta2=args.beta2,epsilon=args.epsilon, weight_decay=args.weight_decay)
    elif args.optimizer == "nadam":
        return Nadam(weights,biases,lr=args.learning_rate,beta1=args.beta1,beta2=args.beta2,epsilon=args.epsilon, weight_decay=args.weight_decay)
    else:
